...
| 2.0 | 2026-02-06 | Mark Dackus | Toegevoegd: UC2.6 Logboek voor een project, UC4.8 Embedded code creëren en delen. Uitwerking van twee nieuwe user stories. | Gepubliceerd |
...
### UC2.6: Logboek voor een project

**Actoren:** Student  
**Precondities:** 
- Student is ingelogd
- Student heeft minimaal één project (als concept of gepubliceerd)

**Beschrijving:**  
Een student houdt per project een logboek bij waarin voortgang, wijzigingen en notities worden vastgelegd. Het logboek ondersteunt reflectie en documentatie van het ontwikkelproces.

**Belangrijke stappen:**
1. Student navigeert naar "Mijn Projecten"
2. Student selecteert het project waarvoor hij/zij het logboek wil openen of bijwerken
3. Student klikt op "Logboek" of "Projectlogboek"
4. Systeem toont het logboek van het project (chronologisch, nieuwste eerst of oudste eerst)
5. Student kan:
   - Bestaande logboekentries bekijken
   - Nieuwe logboekentry toevoegen
6. Bij toevoegen: Student vult in:
   - Datum (standaard: vandaag)
   - Korte titel of onderwerp
   - Beschrijving (voortgang, wijziging, beslissing, notitie)
   - Optioneel: bijlage of link
7. Student klikt op "Opslaan" of "Toevoegen"
8. Systeem valideert de invoer
9. Systeem slaat de logboekentry op en koppelt deze aan het project
10. Systeem toont bevestigingsmelding en vernieuwt de logboekweergave

**Alternatieve flows:**

**A1: Verplichte velden ontbreken**
- 8a. Systeem detecteert dat titel of beschrijving ontbreekt
- 8b. Systeem toont foutmelding: "Vul minimaal een onderwerp en beschrijving in"
- 8c. Student kan ontbrekende velden invullen
- Flow gaat terug naar stap 6

**A2: Logboekentry bewerken**
- 5a. Student klikt op "Bewerken" bij een bestaande entry
- 5b. Systeem toont bewerkformulier met bestaande inhoud
- 5c. Student past de entry aan en slaat op
- Flow gaat verder bij stap 8

**A3: Logboekentry verwijderen**
- 5a. Student klikt op "Verwijderen" bij een bestaande entry
- 5b. Systeem vraagt om bevestiging
- 5c. Student bevestigt
- 5d. Systeem verwijdert de entry uit het logboek
- Flow eindigt

**A4: Geen project geselecteerd**
- 2a. Student probeert direct naar logboek te gaan zonder project
- 2b. Systeem toont "Mijn Projecten" of foutmelding: "Selecteer eerst een project"
- Flow eindigt

**Postcondities:**
- Logboek van het project is zichtbaar en up-to-date
- Nieuwe of gewijzigde entry is opgeslagen en gekoppeld aan het project
- Student kan het logboek later opnieuw openen voor reflectie of beoordeling

**Gerelateerde Requirements:** FE20.1, FE20.2, FE20.3, FE20.4
...
### UC4.8: Embedded code creëren en delen

**Actoren:** Bezoeker, Student, Docent, Beheerder  
**Precondities:** 
- Project bestaat en is gepubliceerd (of gebruiker is eigenaar/docent/beheerder)
- Project heeft minimaal één screenshot/afbeelding, een titel en een korte omschrijving

**Beschrijving:**  
Een gebruiker genereert embedbare code (iframe/script) voor een project, zodat het project elders getoond kan worden (eigen website, portfolio, blog). In de embedded weergave speelt een kleine presentatie af met screenshots van het project, de projecttitel en de korte omschrijving.

**Belangrijke stappen:**
1. Gebruiker opent de detailpagina van een project
2. Gebruiker klikt op "Delen" of "Embed" of "Code om te delen"
3. Systeem toont opties voor delen (bijv. link kopiëren, embedded code)
4. Gebruiker selecteert "Embedded code" of "Code om in te sluiten"
5. Systeem genereert embedbare code (bijv. iframe of script-tag) op basis van:
   - Project-ID of stabiele project-URL
   - Titel van het project
   - Korte omschrijving
   - Screenshots/afbeeldingen van het project (voor de presentatie)
6. Systeem toont de code in een tekstveld (alleen-lezen) met optie "Kopiëren"
7. Gebruiker kopieert de code naar het klembord
8. Gebruiker plakt de code op de gewenste externe pagina (eigen site, portfolio, etc.)
9. Op de externe pagina laadt de embedded weergave:
   - Een kleine presentatie die afspeelt met:
     - De projecttitel
     - De korte omschrijving
     - De screenshots van het project (carrousel of slideshow)
   - Optioneel: link naar het volledige project op IT Showcase

**Alternatieve flows:**

**A1: Project heeft geen afbeeldingen**
- 5a. Systeem detecteert dat het project geen screenshots/afbeeldingen heeft
- 5b. Systeem toont waarschuwing: "Voeg afbeeldingen toe voor een betere embedded presentatie" en genereert toch code (alleen titel + korte omschrijving)
- Flow gaat verder bij stap 6

**A2: Gebruiker wil alleen link delen**
- 4a. Gebruiker kiest "Link kopiëren" in plaats van embedded code
- 4b. Systeem toont de directe URL naar het project
- 4c. Gebruiker kopieert de link
- Flow eindigt

**A3: Embed niet toegestaan (beheerinstelling)**
- 3a. Beheerder heeft embedded delen uitgeschakeld
- 3b. Systeem toont melding: "Embedden is voor dit project niet beschikbaar"
- Flow eindigt

**A4: Project niet gepubliceerd**
- 1a. Bezoeker probeert embedded code te genereren voor een niet-gepubliceerd project
- 1b. Systeem toont foutmelding: "Alleen gepubliceerde projecten kunnen worden gedeeld via embedded code" (tenzij gebruiker eigenaar/docent/beheerder is)
- Flow eindigt

**Postcondities:**
- Embedbare code is gegenereerd en gekopieerd
- Code kan op een externe pagina worden geplakt
- Bij laden van die pagina toont de embed een kleine presentatie met titel, korte omschrijving en screenshots van het project

**Gerelateerde Requirements:** FE21.1, FE21.2, FE21.3, FE21.4
...
| UC2.6 | Logboek voor een project | Student | Should Have |
...
| UC4.8 | Embedded code creëren en delen | Alle | Should Have |
