...
|--------|-------|--------|-------------|
| 1.0 | 2026-01-09 | Mark Dackus | Eerste versie van het SRS document |
| 1.1 | 2026-01-11 | Mark Dackus | Verwijdering FE2.3 (account blokkeren), FE5.4 projectlink verplicht gemaakt |
...
2. [Inleiding](#1-inleiding)
3. [Scope](#2-scope)
4. [Definities en Afkortingen](#3-definities-en-afkortingen)
5. [Overzicht](#4-overzicht)
6. [Gebruikersbeschrijving](#5-gebruikersbeschrijving)
7. [Functionele Eisen](#6-functionele-eisen)
8. [Niet-Functionele Eisen](#7-niet-functionele-eisen)
9. [Systeemarchitectuur](#8-systeemarchitectuur)
10. [Aannames en Beperkingen](#9-aannames-en-beperkingen)
11. [Glossarium](#10-glossarium)
...
Dit Software Requirement Specification (SRS) document beschrijft de functionele en niet-functionele eisen voor IT Student in Actie. Het document dient als basis voor de ontwikkeling, testen en implementatie van het systeem.

### 1.2 Doel van het Project

Het doel van dit project is het ontwikkelen van IT Student in Actie, een professionele website waarop:
...
IT Student in Actie is een webapplicatie die:
...
1. **Projectbeheer**: Studenten kunnen projecten aanmaken, bewerken en beheren
2. **Profielbeheer**: Studenten kunnen hun profiel aanmaken en bijwerken
3. **Contentweergave**: Publieke weergave van projecten en studentprofielen
4. **Dashboard Showcase**: Docenten kunnen de beste projecten selecteren voor een showcase op het dashboard
5. **Zoeken en filteren**: Bezoekers kunnen zoeken en filteren op verschillende criteria
6. **Beheerfunctionaliteit**: Beheerders kunnen content modereren en beheren
7. **Authenticatie**: Gebruikers kunnen inloggen en uitloggen
...
**Beschrijving:**
Een bezoeker is een niet-ingelogde gebruiker die de website bezoekt om projecten en studentprofielen te bekijken.
...
**Beschrijving:**
Een student is een ingeschreven student van een ICT opleiding die projecten wil presenteren.
...
**Beschrijving:**
Een docent is een begeleider die projecten beoordeelt en goedkeurt.
...
**Beschrijving:**
Een beheerder heeft volledige toegang tot het systeem voor beheer en onderhoud.
...
**Must Have (M):**
- Account aanmaken door beheerders en inloggen
- Project aanmaken, bewerken en verwijderen
- Profiel aanmaken en bewerken
- Publieke weergave van projecten en profielen
- Basis zoek- en filterfunctionaliteit
- Responsive design

**Should Have (S):**
- Project goedkeuring door docenten
- Dashboard showcase met beste projecten (docenten kunnen projecten toevoegen)
- Geavanceerde zoek- en filteropties
- Beheerfunctionaliteit voor beheerders
- Afbeelding upload en beheer
- Links naar externe repositories

**Could Have (C):**
- Project tags en labels
- Project statistieken (aantal views)
- Favorieten functionaliteit voor bezoekers
